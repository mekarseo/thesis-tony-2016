...
HTML;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate() && $model->create()) {
                Yii::$app->session->setFlash('success', Yii::t('app', 'Teacher has been created'));
                
                return $this->redirect(['/management/teacher']);
            }

            Yii::$app->session->setFlash('error', Yii::t('app', 'Teacher has been duplicated'));
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate() && $model->update()) {
                Yii::$app->session->setFlash('success', Yii::t('app', 'Teacher has been updated'));
                
                return $this->redirect(['/management/teacher']);
            }

            Yii::$app->session->set('error', Yii::t('app', 'Teacher has not been updated'));
        }
    ...
    public function actionDelete()
    {
        if (Yii::$app->request->isPost && Yii::$app->request->post('selected') != null) {
            ...
            Yii::$app->session->setFlash('success', Yii::t('app', 'Teacher has been deleted'));
        }
    ...
    public function getList()
    {
        ...
        // Link
        $data['l_create']   = Url::to(['/management/teacher/create']);
        $data['l_delete']   = Url::to(['/management/teacher/delete']);
    ...
    public function getForm()
    {
        ...
        // Link
        $data['l_cancel']   = Url::to(['/management/teacher']);
        ...
        Yii::$app->view->title = $data['t_title'];
        Yii::$app->view->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Management'), 'url' => ['/management']];
        Yii::$app->view->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Teachers'), 'url' => ['/management/teacher']];
        Yii::$app->view->params['breadcrumbs'][] = $data['t_title'];
